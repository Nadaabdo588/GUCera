...
<body style="background-color:#F4E8E8">       
    ...
    <form id="form1" runat="server">
        <br />
        <img src="https://img.icons8.com/bubbles/100/000000/certificate.png"/>
        <br />
        <br />
       
        <asp:TextBox CssClass="Curved" ID="courseText" runat="server" MaxLength="10" placeholder="Course ID"></asp:TextBox>
        <br />
        <br />
        ...
        <asp:Button ID="submitC" CssClass="Curved1" runat="server" Text="Issue Certificate" OnClick="submitC_Click" />
        <br />
