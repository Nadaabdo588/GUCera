<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewFeedbacks.aspx.cs" Inherits="GUCera.View_Feedbacks" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <ul class="nav nav-tabs " style="background-color: #FFFFFF;">
            ...
            <li class="nav-item">
                <asp:LinkButton ID="f" CssClass="nav-link active Label4" aria-current="page" runat="server" Text="Feedbacks" OnClick="fd_Click" />
            </li>
        </ul>
